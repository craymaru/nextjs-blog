    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs mt-2 text-gray-600">craymaru@gmail.com</p>
          <p className="font-bold mt-3">Twitter</p>
          <p className="text-xs mt-2 text-gray-600">@craymaru</p>
        </div>
        <div className="mt-6 flex justify-center">
          <a href="https://twitter.com/craymaru">
            <svg
              className="w-6 h-6 mx-3 text-blue-400"
              fill="currentColor"
          ...
          <a href="https://github.com/craymaru">
            <svg
